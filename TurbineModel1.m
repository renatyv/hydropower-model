classdef TurbineModel1
    ...
    methods (Static)
        ...
        function [eta_Q_u,eta_n_u,eta_eta_u] = getCharacteristic()
            nu_922q=[418,424];
            nu_922n=[66.2,66.7];
            ...
            nu_q_i = nu_q_i*TurbineModel1.Qi_coeff;
            %     preparing uniform grid for resampling
            %   resampling data to uniform grid
            eta_Qs = (0:7:700)*TurbineModel1.Qi_coeff;
            eta_ns = 0:1:100;
...
%                 turbine_eta_m = @(q_i_input,n_i_input)(q_in_i_to_eta(q_i_input*Qi_coeff,n_i_input));
            ...
            eta = q_in_i_to_eta(q_i*TurbineModel1.Qi_coeff,n_i);
        end
    end
end